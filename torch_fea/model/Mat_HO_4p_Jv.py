...
import numpy as np
#%%
# Holzapfel-Ogden (2009) Modelling of passive myocardium
#%% fiber orientation in global sys
def cal_fiber_direction(local_sys):
...
def cal_strain_energy_density(F, Mat, Orientation):
    ...
    a1, a2=cal_fiber_direction(Orientation)
    ...
    #E1=relu(E1)
    #E2=relu(E2)
    W1=(0.5*a/b)*(exp(b*temp1)-1)+(0.5*af/bf)*(exp(bf*E1*E1)-1)
